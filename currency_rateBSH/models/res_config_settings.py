...
class ResCompany(models.Model):
    ...
    def _parse_bcrp_data(self, available_currencies):
        ...
        for currency_datech_code, currency_pe_code in foreigns.items():
            if currency_datech_code not in available_currency_names:
                continue
            ...
            result[currency_datech_code] = (rate, date_rate)
        return result
    ...
    def _parse_nbp_data(self, available_currencies):
        """ This method is used to update the currencies by using NBP (National Polish Bank) service API.
            ...
            Source: https://apps.datech.com/apps/modules/14.0/trilab_live_currency_nbp/
